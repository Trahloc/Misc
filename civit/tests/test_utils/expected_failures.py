...
@contextmanager
def expect_log_error(logger_name: str, level=logging.ERROR, message: Optional[str] = None):
    """
    ...
    if message is not None:
        ...
        assert matching_logs, f"Expected log message containing '{message}' was not found"
