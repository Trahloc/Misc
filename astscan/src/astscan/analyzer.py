# FILE_LOCATION: https://github.com/Trahloc/Misc/blob/main/zeroth_law/src/zeroth_law/templates/analyzer.py.template
"""
...
## DEPENDENCIES:
 - astscan.metrics: For calculating individual metrics.
 - astscan.reporting: For generating reports.
 - astscan.utils: Utility functions.
 - astscan.exceptions: Custom exceptions.
 - logging
 - datetime
"""
