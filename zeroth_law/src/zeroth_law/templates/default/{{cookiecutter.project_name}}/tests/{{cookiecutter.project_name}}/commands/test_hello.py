# FILE_LOCATION: {{cookiecutter.project_name}}/tests/{{cookiecutter.project_name}}/commands/test_hello.py
"""
# PURPOSE: Tests for {{cookiecutter.project_name}}.commands.hello.
...
## DEPENDENCIES:
#   pytest
#   {{cookiecutter.project_name}}.commands.hello
"""
import pytest
