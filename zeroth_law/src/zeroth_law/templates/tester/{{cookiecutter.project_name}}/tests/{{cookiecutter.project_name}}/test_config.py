# FILE_LOCATION: {{ cookiecutter.project_name }}/tests/{{ cookiecutter.project_name }}/test_config.py
"""
# PURPOSE: Tests for {{ cookiecutter.project_name }}.config.
...
def test_load_config_invalid_json():
    ...
    try:
        ...
        from {{ cookiecutter.project_name }}.config import _load_from_file
        try:
