...
def test_template_content(project_dir):
    ...
    assert "from . import commands" in content
...
def test_template_conversion(project_dir):
    ...
    # Check tests directory path conversion
    test_dir = template_dir / "{{cookiecutter.project_name}}" / "tests" / "{{cookiecutter.project_name}}"
    assert test_dir.exists()
    assert not (template_dir / "{{cookiecutter.project_name}}" / "tests" / project_name).exists()  # Old path should not exist
