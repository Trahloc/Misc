# FILE_LOCATION: zeroth_law_template/tests/zeroth_law_template/commands/test_info.py
"""
# PURPOSE: Tests for zeroth_law_template.commands.info.
...
## DEPENDENCIES:
#   pytest
#   zeroth_law_template.commands.info
"""
import pytest
...
def test_info_exists():
    ...
    try:
        ...
        from zeroth_law_template.commands import info
