# FILE_LOCATION: zeroth_law_template/src/zeroth_law_template/cli.py
"""
...
## DEPENDENCIES:
 ...
 - zeroth_law_template.commands: Command implementations
...
from zeroth_law_template.commands import check, version, info
from zeroth_law_template.config import get_config
...
def main(ctx: click.Context, verbose: int = 0, config: Optional[str] = None) -> None:
    """Command-line interface for the zeroth_law_template package."""
    ...
    ctx.obj['logger'] = logging.getLogger('zeroth_law_template')
