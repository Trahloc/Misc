...
docstring_test_cases = [
    AnalyzerCase(
        ...
        expected_violations=[("function", "function_without_docstring", 10)],
        config={
            "max_complexity": 10,
            "max_lines": 100,
            "max_params": 5,
...
parameter_test_cases = [
    AnalyzerCase(
        ...
        expected_violations=[("function_with_many_params", 5, 6)],
        config={
            "max_complexity": 10,
            "max_lines": 100,
            "max_params": 5,
...
statement_test_cases = [
    AnalyzerCase(
        ...
        expected_violations=[("function_with_many_statements", 5, 53)],
        config={
            "max_complexity": 10,
            "max_lines": 100,
            "max_params": 5,
