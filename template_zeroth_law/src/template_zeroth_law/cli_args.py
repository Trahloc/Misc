# FILE_LOCATION: template_zeroth_law/src/template_zeroth_law/cli_args.py
"""
# PURPOSE: Provide reusable command-line arguments for the template_zeroth_law package.
