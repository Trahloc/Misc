# FILE: template_zeroth_law/src/template_zeroth_law/utils/__init__.py
"""
# PURPOSE: Utility functions for the template_zeroth_law package.

## INTERFACES:
 - get_project_root(): Get the root directory of the project
 - sanitize_filename(): Sanitize a filename to be safe for filesystem
...
## IMPROVEMENTS:
 - Centralized utility functions in a single module
 - Added proper type hints and documentation
 - Added robust error handling

## FUTURE TODOs:
 - Add more utility functions as needs arise
 - Consider splitting into submodules if this gets too large
 - Add more extensive validation options
"""
